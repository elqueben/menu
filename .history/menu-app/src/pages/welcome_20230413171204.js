...
export function Welcome() {
    return (
        ...
        <div id="circles" className="container">
            <div className="d-flex justify-content-center">
                <img className="w-25 rounded-circle p-2" src="https://wallpapercave.com/dwp1x/wp1951584.jpg" alt="scene4" />
                <img className="w-25 rounded-circle " src="https://wallpapercave.com/dwp1x/wp1951584.jpg" alt="scene4" />
                <img className="w-25 rounded-circle" src="https://wallpapercave.com/dwp1x/wp1951584.jpg" alt="scene4" />
            </div>
        </div>
