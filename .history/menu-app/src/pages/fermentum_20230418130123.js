    ...
    return (
        <>
            ...
            <div className="container"> 
                <div>                  
                <p>
                    <button className="w-25 border-0 bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#card1" aria-expanded="false" aria-controls="collapseExample">
