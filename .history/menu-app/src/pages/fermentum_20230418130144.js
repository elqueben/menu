    ...
    return (
        <>
            ...
            <div className="container"> 
                ...
                <div>                  
                <p>
                    <button className="w-25 border-0 bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#card2" aria-expanded="false" aria-controls="collapseExample">
                ...
                <div>                  
                <p>
                    <button className="w-25 border-0 bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
