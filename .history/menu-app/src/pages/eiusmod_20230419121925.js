    ...
    return(
        ...
        <h3 className="text-center">incididunt ut labore et dolore magna</h3>
            <div className="w-50 float-left">
                <h5>egestas sed</h5>
                <p className="text-lowercase">Felis eget nunc lobortis mattis aliquam. Pulvinar sapien et ligula ullamcorper malesuada proin libero nunc. Diam sollicitudin tempor id eu nisl. Pulvinar sapien et ligula ullamcorper malesuada proin libero nunc. Sem fringilla ut morbi tincidunt augue interdum velit euismod in. Leo duis ut diam quam.</p>
            </div>
        </div>
        </>
