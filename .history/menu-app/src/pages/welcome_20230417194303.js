    ...
    return (
        ...
        <div className="container pt-1">
            <div className="d-flex justify-content-center">
                <img className="w-25 justify-content" src="https://wallpapercave.com/dwp1x/wp1951584.jpg" />
                <img className="w-25" src="https://wallpapers.com/images/featured-small/anime-scenery-ahd1eqpvwq8aoofp.webp" />
                <img className="w-25" src="https://wallpapers.com/images/high/city-sunset-aesthetic-23eb5xx8c6tv6q59.webp" />
            </div>
        </div>
        <footer>
            <div className="d-flex justify-content-center">
