    ...
    return (
        ...
        <div className="container pt-1">
            <div className="d-flex justify-content-center">
                <img className="rounded mx-auto d-block w-25 p-2" src="https://wallpapercave.com/dwp1x/wp1951584.jpg" alt="scene4" />
                <img className="rounded w-25 p-2" src="https://wallpapers.com/images/featured-small/anime-scenery-ahd1eqpvwq8aoofp.webp" alt="scene4" />
                <img className="rounded w-25 p-2" src="https://wallpapers.com/images/high/city-sunset-aesthetic-23eb5xx8c6tv6q59.webp" alt="scene4" />
            </div>
        </div>
        <footer>
            <div className="d-flex justify-content-center">
